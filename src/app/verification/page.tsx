    ...
    <div className="flex justify-center pt-43">
      <div className="w-full max-w-md px-6">
        ...
        <form className="space-y-4">
          ...
          <Link
            href="/login"
            className="block w-full text-center bg-[#E30022] text-white font-bold px-4 py-3 rounded-md border border-transparent transition-all duration-300 ease-in-out hover:bg-transparent hover:text-red-500 hover:border-red-500"
          >
            SET PASSWORD
          </Link>
        </form>
