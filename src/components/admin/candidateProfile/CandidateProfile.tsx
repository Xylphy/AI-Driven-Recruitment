...
export default function CandidateProfile({
  ...
  const pageTabs = [
    { key: PageKey.Score, label: "Score" },
    { key: PageKey.Highlights, label: "Highlights" },
  ] as const;

  const [activePage, setActivePage] = useState<PageKey>(PageKey.Score);
  ...
  return (
    <div className="w-full h-full relative overflow-hidden bg-linear-to-br from-red-50 via-white to-red-100">
      ...
      <div className="h-full flex flex-col gap-6">
                ...
                return (
                  <button
                    ...
                    className={[
                      ...
                      "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-400/60 focus-visible:ring-offset-2",
                      active
        ...
        <div className="flex-1 overflow-hidden rounded-3xl border border-white/60 bg-white/45 backdrop-blur-2xl shadow-[0_20px_70px_rgba(0,0,0,0.10)]">
          <div className="h-full overflow-y-auto p-7 scrollbar-thin scrollbar-thumb-red-200/80 scrollbar-track-transparent">
            {activePage === PageKey.Score && (
